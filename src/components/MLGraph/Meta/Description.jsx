  ...
  getAllDataByYear(year, data) {
    ...
    render() {
      let formatter = this.getFormatter(),
        ...
        return (
            <p className="lead">{yearFragment.length ? yearFragment : "Since 2010"}, {USStateFragment} money launderers {yearFragment.length ? "commited" : "have commited"} {N} crimes{previousYearFragment}. Each laundered amount was between ${min_salary} and ${max_salary} per year.</p>
        )
    }
}
